...
def retrieve_yt_url(config, url, video_id)
...
yt_response[video_url] = retrieve_yt_url(config, video_url, '8bZh5LMaSmE')
...
yt_response[caption_url] = retrieve_yt_url(config, caption_url, '8bZh5LMaSmE')
